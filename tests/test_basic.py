...
def test_expression_rel(run_lox):
    ...
    assert run_lox("echo (3+1) > 4;") == "false"
    assert run_lox("echo (3+1) == 4;") == "true"
    assert run_lox("echo (3+1) >= 4;") == "true"
    assert run_lox("echo (3+1) < 4;") == "false"
    assert run_lox("echo (3+1) <= 4;") == "true"
    assert run_lox("echo (3+1) != 4;") == "false"