...
def test_addition(run_lox):
    assert run_lox("print 1 + 2;") == "3"


def test_subtraction(run_lox):
    assert run_lox("print 5 - 3;") == "2"


def test_multiplication(run_lox):
    assert run_lox("print 4 * 2;") == "8"


def test_division(run_lox):
    assert run_lox("print 8 / 2;") == "4"


def test_grouping(run_lox):
    assert run_lox("print (1 + 2) * 3;") == "9"


def test_negation(run_lox):
    assert run_lox("print -5;") == "-5"


def test_comparison_greater(run_lox):
    assert run_lox("print 5 > 3;") == "true"


def test_comparison_less(run_lox):
    assert run_lox("print 3 < 5;") == "true"


def test_comparison_equal(run_lox):
    assert run_lox("print 4 == 4;") == "true"


def test_comparison_not_equal(run_lox):
    assert run_lox("print 4 != 5;") == "true"
...
def test_expression_rel(run_lox):
    assert run_lox("print (3+2) > 4;") == "true"
    assert run_lox("print (3+2) == 4;") == "false"
    assert run_lox("print (3+2) >= 4;") == "true"
    assert run_lox("print (3+2) < 4;") == "false"
    assert run_lox("print (3+2) <= 4;") == "false"
    assert run_lox("print (3+2) != 4;") == "true"
    ...
    assert run_lox("print (3+1) > 4;") == "false"
    assert run_lox("print (3+1) == 4;") == "true"
    assert run_lox("print (3+1) >= 4;") == "true"
    assert run_lox("print (3+1) < 4;") == "false"
    assert run_lox("print (3+1) <= 4;") == "true"
    assert run_lox("print (3+1) != 4;") == "false"